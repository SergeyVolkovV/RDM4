...
<h1>Reference Data Manager - Technical Description Content</h1>
<h2>Tables</h2>
...
<tr>
	...
	<td class="lowerCase"><i><a href="tech/doc_{@name}.html"><xsl:value-of select="@name"/></a></i></td>
</tr>
</xsl:for-each>
...
<tr>
	...
	<td class="lowerCase"><i><a href="tech/doc_{@nameView}.html"><xsl:value-of select="@nameView"/></a></i></td>
</tr>
</xsl:for-each>
...
<h1>Správa číselníků - technický popis</h1>
<h2>Tabulky</h2>
...
<tr>
	<td><xsl:value-of select="@label"/></td>
	<td><xsl:value-of select="@name"/></td>
	<td><i><a href="csv/{@name}.txt">detail</a></i></td>
</tr>
</xsl:for-each>
...
<tr>
	<td><xsl:value-of select="@labelView"/></td>
	<td><i><a href="csv/{@nameView}.txt">detail</a></i></td>
</tr>
</xsl:for-each>
